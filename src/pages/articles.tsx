...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
  return (
    ...
    >
      <div className="absolute top-0 -right-3 -z-10 h-[103%] w-[101%] rounded-[2rem] rounded-br-3xl bg-dark dark:bg-light" />
      <Link
        href={link}
        target="_blank"
...
const Article = ({ img, title, date, link }) => {
  return (
    ...
    dark:bg-dark dark:border-light dark:text-light sm:flex-col"
      initial={{ y: 200 }}
